       ...
       .on("child_added", newPost => {
         postPrint.innerHTML += `
                <ul class="list-group list-group-flush" style="width: 100%;" id="${newPost.Key}"> 
                  ...
                  <i class="fas fa-edit" onclick="updatePost("${newPost.Key}","${newPost.val().text}") id="editPost"> </i> <i class="fas fa-trash-alt" data-post="${newPost.Key}" onclick="deletePost(event)"></i> 
                  </li>
                </ul>
            `;
       });
